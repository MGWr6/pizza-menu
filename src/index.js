...
root.render(
  // strict mode renders components twice in order to find certain bugs during development and also react will check if we are using outdated parts of the react API
  <React.StrictMode>
    <App />
  </React.StrictMode>,
);
